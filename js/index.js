document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`http://localhost:3000/monsters?_limit=20&_page=${pageNumber}`)
      ...
      .then((monsters) => {
        if(monsters.length === 0) {
          monstersDiv.innerHTML = `<h2>There are no monsters on this page</h2>`
        } else {
  ...
  //render monster to top of page, for create
  ...
  //delete monster event for button
  ...
  //turn pages with forward & back buttons
